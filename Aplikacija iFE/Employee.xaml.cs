...
namespace Aplikacija_iFE
{
    public sealed partial class Employee : Page
    {
        ...
        private  async void Poslji_hitro_sporocilo_Click(object sender, RoutedEventArgs e)
        {
              ...
              )
            {
                ...
                sporocilo.Content = "Sporočilo je bilo uspešno poslano! (Trenutno se vse pošilja na e-mail ak3900@student.uni-lj.si)";
                Zadeva.Text = "";HitroSporocilo.Text = "";
            }
            else
            {
